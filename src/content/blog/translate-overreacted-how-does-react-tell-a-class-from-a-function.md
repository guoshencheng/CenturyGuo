...
description: "我们可以先来看一下这个用函数定义的Greeting组件:"
---

> 本文出自[overreacted](https://overreacted.io/)，这是[Dan Abramov](https://mobile.twitter.com/dan_abramov)写的博客，我觉得对很有用所以特意做了这个翻译[系列](/tags/overreacted)，原文链接请查看[这里](https://overreacted.io/how-does-react-tell-a-class-from-a-function/)
