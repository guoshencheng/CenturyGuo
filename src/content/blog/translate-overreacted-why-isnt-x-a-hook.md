...
description: "自从第一个拥有React Hooks的React的alpha版本发布之后。不断地会有人提出一些类似于这样的问题: \"为什么 某个API 不做成Hook\"。"
---

> 本文出自[overreacted](https://overreacted.io/)，这是[Dan Abramov](https://mobile.twitter.com/dan_abramov)写的博客，我觉得对很有用所以特意做了这个翻译[系列](/tags/overreacted)，原文链接请查看[这里](https://overreacted.io/why-isnt-x-a-hook/)
